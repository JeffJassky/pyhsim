...
- **Proposed State:** `melatonin` baseline returns values in **pg/mL**.
  - _Night Peak:_ ~60–100 pg/mL.
  - _Day Baseline:_ < 5 pg/mL.
...
- **Example (Caffeine):**
  - _Current:_ `return I * (p.mg/100) * 0.3 * pk;`
  - _Proposed:_ `const concentration = p.mg / (subject.weight * Vd_caffeine);`
  - _Value:_ This allows the simulation to naturally account for how a 50kg person responds to 200mg of caffeine vs. a 100kg person.
...
- **The Tooltip:** Shows both: _"Glucose: 0.82 (115 mg/dL)"_.
- **The Inspector:** Shows the "Reference Range" context: _"Your predicted Cortisol peak is 22 µg/dL (High-Normal)."_
