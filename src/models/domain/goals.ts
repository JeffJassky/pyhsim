    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "Antagonizes adenosine receptors to clear brain fog and stimulates dopamine for drive.",
      },
      {
        key: "nap",
        label: "Power Nap",
        ...
        readout:
          "A brief sleep cycle that reduces sleep pressure without causing grogginess.",
      },
      {
        key: "exercise_cardio",
        label: "Morning Run",
    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "Optimizes dopamine and norepinephrine levels in the prefrontal cortex.",
      },
      {
        key: "ltheanine",
        label: "L-Theanine",
      ...
      },
      {
        ...
        readout:
          "Resets your sensory baseline to help you lock in on a single task.",
      },
    ],
  },
  {
    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "High intensity effort that depletes glycogen and triggers fat oxidation.",
      },
      {
        key: "food",
        ...
        readout:
          "Triggers GLP-1 and PYY to keep you full while boosting metabolism.",
      },
    ],
  },
  {
    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "Natural antidepressant that elevates mood-regulating neurotransmitters.",
      },
      {
        key: "social",
        ...
        readout:
          "Lowers cortisol and boosts bonding hormones for emotional stability.",
      },
      {
        key: "ltheanine",
        ...
        readout:
          "Modulates brain chemistry to smooth out emotional peaks and valleys.",
      },
    ],
  },
  {
    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "Directly stimulates the central nervous system for immediate clarity.",
      },
      {
        key: "meditation",
        label: "Mindfulness",
        ...
        readout:
          "Trains your brain to return to the task at hand when distracted.",
      },
    ],
  },
  {
    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "The foundation of recovery, maximizing growth hormone release.",
      },
      {
        key: "magnesium",
        label: "Magnesium",
        ...
        readout:
          "Essential mineral that lowers cortisol and supports cellular repair.",
      },
      {
        key: "electrolytes",
        label: "Hydration",
  ...
  },
  {
    ...
    recommendedInterventions: [
      ...
      },
      {
        ...
        readout:
          "Shifts your nervous system into rest-and-digest mode before bed.",
      },
    ],
  },
  {
    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "Decouples the sensation of pain from the emotional reaction to it.",
      },
      {
        key: "sleep",
    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "Adjusting intensity to match your follicular or luteal phase.",
      },
      {
        key: "food",
        ...
        readout:
          "Supporting progesterone production with stable energy sources.",
      },
    ],
  },
  {
    ...
    recommendedInterventions: [
      {
        ...
        readout:
          "Increases mitochondrial density and efficiency for long-term healthspan.",
      },
      {
        key: "sleep",
        label: "Quality Sleep",
        ...
        readout:
          "Activates the glymphatic system to clear metabolic waste from the brain.",
      },
      {
        key: "magnesium",
        ...
        readout:
          "Supports over 300 biochemical reactions essential for cellular maintenance.",
      },
    ],
  },
];
