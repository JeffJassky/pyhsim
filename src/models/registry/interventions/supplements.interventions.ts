...
export const SUPPLEMENT_INTERVENTIONS: InterventionDef[] = [
  ...
  // =============================================================================
  {
    ...
    pharmacology: (params) => Agents.Inositol(Number(params.mg) || 2000),
    group: "Supplements",
    categories: ["supplements"],
    goals: ["calm", "mood"],
  },
  {
    ...
    pharmacology: (params) => Agents.Zinc(Number(params.mg) || 30),
    group: "Supplements",
    categories: ["supplements"],
  ...
  },
  {
    ...
    pharmacology: (params) => Agents.Copper(Number(params.mg) || 1),
    group: "Supplements",
    categories: ["supplements"],
    goals: ["recovery"],
  },
  ...
  },
  {
    ...
    pharmacology: (params) => Agents.Chromium(Number(params.mcg) || 500),
    group: "Supplements",
    categories: ["supplements"],
    goals: ["weightLoss"],
  },
  {
    ...
    pharmacology: (params) => Agents.Rhodiola(Number(params.mg) || 300),
    group: "Supplements",
    categories: ["supplements"],
  ...
  },
  {
    ...
    pharmacology: (params) => Agents.CDPCholine(Number(params.mg) || 250),
    group: "Supplements",
    categories: ["supplements"],
    goals: ["focus", "energy"],
  },
  {
    ...
    pharmacology: (params) => Agents.LCarnitine(Number(params.mg) || 500),
    group: "Supplements",
    categories: ["supplements"],
    goals: ["energy", "focus"],
  },
